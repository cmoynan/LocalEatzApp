...
urlpatterns = [
    ...
    # Route for account management handled by allauth (e.g., login, signup, etc.)
    path('my-bookings/', views.my_bookings, name='my_bookings'),
    # Route to list all bookings for the logged-in user, handled by the my_bookings view
    path('book_table/<int:restaurant_id>/', views.book_table, name='book_table'),
    # Route to book a table at a specific restaurant, handled by the book_table view
    ...
    # Route to display a booking success message, handled by the booking_success view
